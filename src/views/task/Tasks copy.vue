    ...
    <v-form ref="form" v-model="valid">
      <v-card>
        ...
        <v-card-actions>
          <v-spacer></v-spacer>
          <v-btn color="#DA7171" variant="flat" @click="close">Cancelar</v-btn>
          <v-btn color="#03626C" variant="flat" :loading="loading" @click="save" :disabled="(!valid  || !editedItem.people.length)">Aceptar</v-btn>
        </v-card-actions>
      </v-card>
    </v-form>
  </v-dialog>
...
.custom-tooltip {
  ...
  color: #E5E5E5 !important;              /* Texto oscuro */
...
.selected-tab {
  background-color: #03626C; /* Fondo del tab seleccionado */
