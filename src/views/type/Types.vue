<template>
    ...
    <v-card elevation="6" class="mx-2">
        ...
        <v-card-text>
            ...
            <v-data-table :headers="headers" :search="search" :items="types" class="elevation-1"
                        ...
                        <v-row>
                            <v-col cols="12" md="6">
                                <v-text-field v-model="editedItem.name" clearable label="Nombre"
                                    prepend-icon="mdi-tag-outline" variant="underlined" :rules="nameRules"
                                    density="compact"></v-text-field>
                            </v-col>
                            <v-col cols="12" md="6">
                                <v-autocomplete :no-data-text="'No hay datos disponibles'" v-model="editedItem.type"
                                    :items="typeOptions" label="Tipos" prepend-icon="mdi-shape-outline"
                                    item-title="name" item-value="id" variant="underlined" :rules="selectRules" density="compact">
                                </v-autocomplete>
                            </v-col>
                            <v-col cols="12" md="12">
                                <v-textarea v-model="editedItem.description" clearable label="Descripción"
                                    prepend-icon="mdi-text-box-outline" variant="underlined" density="compact"></v-textarea>
                            </v-col>
                        </v-row>
                    </v-container>
                </v-card-text>
