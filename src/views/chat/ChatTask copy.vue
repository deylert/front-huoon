...
.chat-bubble .v-text-field,
.chat-bubble .v-textarea {
  width: 100%;
}

.chat-bubble .v-text-field .v-field,
.chat-bubble .v-textarea .v-field,
.chat-bubble .v-input__control,
.chat-bubble .v-field__input {
  width: 100%;
